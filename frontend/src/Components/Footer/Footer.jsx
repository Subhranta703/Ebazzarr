...
const Footer = () => {
  ...
  const sendMessage = () => {
    window.location = `https://wa.me/8260912891?text=${message}`;
  };
  return (
    <>
      <footer>
        <section className="footer">
          <div className="box-container">
            <div className="box">
              <h3>
                Groco-com <i>{<RiShoppingBasketFill />}</i>
              </h3>
              <p>
              ...
              <div className="share">
                <Link>
                  <i
                    onClick={() => {
                      window.location = `https://wa.me/8260912891?text=Say Hello..!!`;
                    }}
                  >
                    {<IoLogoWhatsapp />}
                  </i>
                </Link>
                <a href="https://www.instagram.com/subhranta_703/profilecard/?igsh=MTczNGRkbmczdXZieA==">
            ...
            <div className="box">
              ...
              <a href="mailto:subhrantanayak6535@gmail.com" className="links">
                <i>
                  <MdOutlineMarkEmailRead />
                </i>
                subhrantanayak6535@gmail.com
              </a>
          ...
          <div className="credit">
            Created By <span>Subhranta Kumar Nayak </span> | All Right Reserved
          </div>
        </section>
      </footer>
    </>
